    ...
    return (
        <div className='mt-10 flex flex-col items-center '>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative max-w-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-zinc-900 py-5 flex flex-col items-center gap-4 mt-6 mb-6 w-[50%] rounded-xl shadow-sm">
                ...
                <button type="submit" disabled={isSubmitting} className="w-[50%] bg-black dark:bg-white text-white dark:text-black p-2.5 rounded-lg mt-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-800 dark:hover:bg-gray-300">{isSubmitting ? "Signing in..." : "Sign In"}</button>
            </form>
